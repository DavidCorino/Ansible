...
COUNT_TOTAL0=`tail -n 20000 $1 | grep "$2" | grep "$(date +%H:%M)" | wc -l`
COUNT_TOTAL1=`tail -n 20000 $1 | grep "$2" | grep "$(date +%H:%M -d '-1 minutes' )" | wc -l`
COUNT_TOTAL2=`tail -n 20000 $1 | grep "$2" | grep "$(date +%H:%M -d '-2 minutes' )" | wc -l`
COUNT_TOTAL3=`tail -n 20000 $1 | grep "$2" | grep "$(date +%H:%M -d '-3 minutes' )" | wc -l`
COUNT_TOTAL4=`tail -n 20000 $1 | grep "$2" | grep "$(date +%H:%M -d '-4 minutes' )" | wc -l`
